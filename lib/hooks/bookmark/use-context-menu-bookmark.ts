...
import { getContextAtPosition } from "@/lib/utils/bookmark/bookmark-renderer";
import { generateSelector } from "@/lib/utils/bookmark/generate-bookmark-selector";
...
export function useContextMenuBookmark() {
    ...
    const showMenu = useCallback(
        ...
        [getTextPositionFromPoint, calculateMenuPosition]
    );
